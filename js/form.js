...
$(document).ready(function(){
            ...
            $(document).on('click', '.ui.vk.button', function(event){
                
                $('.addOptionZone').append('<input type="text" name="">');
            });
            $('#nextText').click(function(){
                questCount++;
                $('#origin').append('<div class="ui two column relaxed grid"><div class="column"><div class="ui segment"><form class="ui form"><div class="ui form"><label>第 '+ questCount + ' 題</label><textarea placeholder="問卷說明" id="titleTextarea" name="surveyDetail" style="overflow:hidden"></textarea></div><div class="ui form"><div class="field"><label>答題方式</label><p>單選</p></div></div></form></div></div><div class="column" ><div class="ui segment" id="origin2"><div class="ui orange inverted segment"><h2 id="displayTitle" class="ui center aligned  orange inverted segment"></h2><label>說明</label><p id="displayTexArea"></p><div class="ui input"><input type="text" name="" id="" disabled></div></div></div></div></div>');

            });
            $('#nextTextArea').click(function(){
                questCount++;
                $('#origin').append('<div class="ui two column relaxed grid"><div class="column"><div class="ui segment"><form class="ui form"><div class="ui form"><label>第'+ questCount + '題</label><textarea placeholder="問卷說明" id="titleTextarea" name="surveyDetail" style="overflow:hidden"></textarea></div><div class="ui form"><div class="field"><label>答題方式</label><p>多選</p></div></div></form></div></div><div class="column" ><div class="ui segment" id="origin2"><div class="ui orange inverted segment"><h2 id="displayTitle" class="ui center aligned  orange inverted segment"></h2><label>說明</label><p id="displayTexArea"></p><input type="text" name="" id="" disabled></div></div></div></div>');
            });
            $('#nextRadioBtn').click(function(){
                questCount++;
                var optionCount = 1;
                $('#origin').append('<div class="ui two column relaxed grid"><div class="column"><div class="ui segment"><form class="ui form"><div class="ui form"><label>第 '+ questCount + ' 題</label><textarea placeholder="問卷說明" id="titleTextarea" name="surveyDetail" style="overflow:hidden"></textarea></div><div class="ui form"><div class="field"><div class="addOptionZone"><label>選項名稱</label><input type="button" value="添加選項"  class="ui vk button"><label for="">'+ optionCount +'</label><input type="text" name=""></div></div></div></form></div></div><div class="column" ><div class="ui segment" id="origin2"><div class="ui orange inverted segment"><h2 id="displayTitle" class="ui center aligned  orange inverted segment"></h2><label>說明</label><p id="displayTexArea"></p></div></div></div></div>');
            });
