        ...
        <form class="uk-form uk-form-horizontal" name="form" method="post" action="register_check.php">
            <fieldset>
                ...
                <div class="uk-form-row">
                    ...
                    <input type="text" placeholder="Enter username" class="uk-form-width-medium" id="username" required autofucus>
                </div>
                <div class="uk-form-row">
                ...
                <div class="uk-form-row">
                    ...
                    <input type="password" placeholder="Enter Password" class="uk-form-width-medium" id="repeatPassword" required>
                </div>
